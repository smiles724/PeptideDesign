...
from dflow.data.datasets import PdbDataset
from dflow.data.protein_dataloader import ProteinData
from dflow.experiments import utils as eu
from dflow.models.flow_module import FlowModule
...
class Experiment:
    ...
    def __init__(self, *, cfg: DictConfig):
        ...
        self._all_angles = self._data_cfg.all_angles
        print(self._all_angles)
    ...
    def _setup_dataset(self):
        ...
        if self._data_cfg.dataset == 'pdb':
            self._train_dataset, self._valid_dataset = eu.dataset_creation(PdbDataset, self._cfg.pdb_dataset, self._task, self._all_angles)
