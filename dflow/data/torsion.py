...
import dflow.data.pep_constants as constants
from dflow.models.geometry import *
...
def get_torsion_angle(pos14: torch.Tensor, aa: torch.LongTensor, all_angles=False):
    ...
    for i in range(pos14.shape[0]):
        if aa[i] < constants.AA.UNK:  # 0-19
            ...
            if all_angles:
                ...
                torsion_this = torch.cat([psi, chi], dim=0)  # [omega, phi, psi, chi]
