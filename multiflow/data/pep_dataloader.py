...
from multiflow.data.parsers import parse_pdb
from multiflow.data.pep_constants import BBHeavyAtom, PAD_RESIDUE_INDEX
from multiflow.data.torsion import get_torsion_angle
...
class PepDataset(Dataset):
    ...
    def __init__(self, structure_dir="./Data/PepMerge/", dataset_dir="./Data/", name='pep', x_mirror=None, reset=False):
        super().__init__()
        self.structure_dir = structure_dir
        self.dataset_dir = dataset_dir
        self.name = name
        self.x_mirror = x_mirror  # TODO: support more mirror
